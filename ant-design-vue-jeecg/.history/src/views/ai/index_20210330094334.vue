  ...
  <div class="box">
    ...
    <div class="up" style="display: inline-block">
      <a-upload
        ...
        @change="handleChange"
      >
        <a-button type="primary" icon="cloud">点击上传</a-button>
      </a-upload>
      <a-button @click="daochu" type="primary" icon="cloud-download">导出</a-button>
    </div>
    <div id="data" style="overflow: scroll;width: 100%;height:800px;padding: 0">
